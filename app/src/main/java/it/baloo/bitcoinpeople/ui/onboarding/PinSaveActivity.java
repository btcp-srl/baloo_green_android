package it.baloo.bitcoinpeople.ui.onboarding;
...
import it.baloo.bitcoinpeople.ui.authentication.PinFragment;
...
public class PinSaveActivity extends GaActivity implements PinFragment.OnPinListener {
    ...
    private static final String NEW_PIN_MNEMONIC = "it.baloo.bitcoinpeople.NewPinMnemonic";
